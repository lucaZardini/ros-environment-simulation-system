...
add_custom_target(dist_project_generate_messages ALL)
...
_generate_module_cpp(dist_project
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/dist_project
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(dist_project_generate_messages_cpp
...
add_dependencies(dist_project_gencpp dist_project_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS dist_project_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(dist_project
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/dist_project
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(dist_project_generate_messages_eus
...
add_dependencies(dist_project_geneus dist_project_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS dist_project_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(dist_project
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/dist_project
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(dist_project_generate_messages_lisp
...
add_dependencies(dist_project_genlisp dist_project_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS dist_project_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(dist_project
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/dist_project
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(dist_project_generate_messages_nodejs
...
add_dependencies(dist_project_gennodejs dist_project_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS dist_project_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(dist_project
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dist_project
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(dist_project_generate_messages_py
...
add_dependencies(dist_project_genpy dist_project_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS dist_project_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/dist_project)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/dist_project
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/dist_project)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/dist_project
...
if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/dist_project)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/dist_project
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/dist_project)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/dist_project
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dist_project)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dist_project\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dist_project
