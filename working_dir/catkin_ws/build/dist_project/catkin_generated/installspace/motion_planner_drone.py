...
class MotionPlanner3d:
    ...
    def __init__(self, drone_id):
        ...
        self.rescue_completed_sub = rospy.Subscriber("/completed_rescue", target_data, self.completed_rescue_callback)
    ...
    def completed_rescue_callback(self, msg):
        if msg.robot_id != self.drone_id:
            if self.current_state == RobotState.RESCUING or self.current_state == RobotState.RESCUE:
